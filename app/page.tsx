        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center">
            <Link href="/" className={`${playfair.className} text-2xl font-bold text-gray-900`}>
              SAT<span className="text-blue-600">Tutor</span>
            </Link>
          </div>
        </div>
      </nav>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          <div className="inline-block mb-4">
            <span className="bg-blue-100 text-blue-800 text-sm font-medium px-4 py-1.5 rounded-full">New Digital SAT Format</span>
          </div>
          <h1 className={`${playfair.className} text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-6 tracking-tight`}>
            Master the SAT<span className="text-blue-600">.</span>
          </h1>
          <p className="text-xl md:text-2xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed">
            Your personal study companion for SAT success. Expert guidance, practice tests, and personalized learning paths.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6">
            <Link href="/math" className="bg-blue-600 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-blue-700 transition duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
              Practice Math
            </Link>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition duration-300 transform hover:-translate-y-2 border-t-4 border-blue-500">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">Math & Verbal</h3>
            <p className="text-gray-600">Comprehensive coverage of all SAT sections with detailed explanations and step-by-step solutions.</p>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition duration-300 transform hover:-translate-y-2 border-t-4 border-yellow-500">
            ...
            <p className="text-gray-600">Full-length practice tests with detailed score analysis and performance tracking over time.</p>
          </div>
        </div>
        ...
        <div className="mt-20 bg-white rounded-2xl shadow-xl p-8 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-xl text-gray-600 mb-6 italic">
              "This SAT prep platform transformed my study habits. The personalized approach helped me focus on my weak areas, and I saw my practice scores improve by over 200 points!"
            </p>
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-gray-500 text-sm">Harvard '27</p>
              </div>
            </div>
          </div>
        </div>
